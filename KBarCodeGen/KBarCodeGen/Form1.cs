       ...
       public Bitmap barcodeImage;
        ...
        private void GenerateBarcode_DataMatrix(string inputData)
        {
            ...
            try // Encode
                ...
                setEncodingScheme(); // scheme options
                setModuleSize();// module size options
                setMargin();// margin size options
                ...
                // Copy Barcode Image to PictureBox Control on Form
                PicBox1.Image = barcodeImage;
                }
                catch (Exception ex)
                {
        ...
        private void setEncodingScheme()
        {
